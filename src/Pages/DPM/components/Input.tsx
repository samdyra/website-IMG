...
export function Input({ entry, handleNewCommand }: Props) {
  ...
  return (
    <div
      ...
      className={classNames("w-full p-3 font-code", input.state.askForPassword ? "h-16" : "h-10")}
    >
      <div className="flex items-center h-4 font-code">
        <span className="mr-2">
          <ArrowRight className={classNames("fill-current", arrowTextColor)} width={15} />
        </span>
        <span className="mr-2 text-blue-300 font-code">~</span>
