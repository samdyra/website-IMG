...
export default function AddKamerad() {
  ...
  const handlePublish = () => {
    ...
    const storageRef = ref(storage, `/geosphere/${formData.image.name}`);
    ...
    uploadImage.on(
      ...
      () => {
        ...
        getDownloadURL(uploadImage.snapshot.ref).then((url) => {
          const kameradRef = collection(db, "geosphere");
          addDoc(kameradRef, {
      ...
      {!user ? (
        ...
        <div className="formadmincontainer">
          ...
          <div className="formadmin">
            <label htmlFor="">Judul geosphere</label>
            <textarea
              name="judul"
          ...
          <div className="formadmin">
            <label htmlFor="">link PDF geosphere</label>
            <textarea
              name="pdf"
              className="form-control"
              value={formData.pdf}
