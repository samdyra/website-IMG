...
const Kamerads = () => {
  ...
  const dataMajalah = useLoadDataWithOffset("geosphere", 3, offset)
  ...
  return (
    <div>
      ...
      <div style={{ marginBottom: 300 }}>
        <div className="warning" >Majalah geosphere</div>
                ...
                <div className="kameradContainerz">
                  <div key={id} className="kamerad-container-id">
                    ...
                    <div className="kamerad-idz">
                      ...
                      <div>{desc}</div>
                      {/* <div>{pembuat}</div> */}
                      {user && <UseDeleteDataWithImage id={id} image={image} type="geosphere" collection="geosphere"/>}
                    </div>
                  </div>
                </div>
              ))
