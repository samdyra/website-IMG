...
const Kamerads = () => {
  ...
  const dataMajalah = useLoadDataWithOffset("imgx", 3, offset)
  ...
  return (
    <div>
      ...
      <div style={{ marginBottom: 300 }}>
        <div className="warning" >Berita IMGX</div>
                ...
                <div className="kameradContainerz">
                  <div key={id} className="kamerad-container-id">
                    ...
                    <div className="kamerad-idz">
                      ...
                      <div>{desc}</div>
                      {/* <div>{pembuat}</div> */}
                      {user && <UseDeleteDataWithImage id={id} image={image} type="imgx" collection="imgx"/>}
                    </div>
                  </div>
                </div>
              ))
